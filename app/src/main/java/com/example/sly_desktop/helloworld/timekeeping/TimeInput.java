...
public class TimeInput {
    ...
    private Timestamp phoneTime;
    private Timestamp inputTime;


    public TimeInput(Timestamp pPhoneTime, Timestamp pInputTime){
        this.phoneTime = pPhoneTime;
        this.inputTime = pInputTime;
    }

    public static Timestamp calculateTimeDifference (java.util.Date t1, java.util.Date t2)
    {
